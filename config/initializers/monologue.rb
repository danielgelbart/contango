Monologue.config do |config|
  config.site_name = "Articles"
  config.site_subtitle = "latest"
  config.site_url = "http://www.publicsecurities.com"

  config.layout  = "layouts/application" # set the layout you want to use if you want to use your main_app layout

  config.meta_description = "This is my blog about..."
  config.meta_keyword = "excel, financial, statements"
